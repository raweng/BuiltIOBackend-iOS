 ...
 */
- (void)sendNotificationToUsers:(NSArray *)users error:(NSError **)error BUILTIO_DEPRECATED("Synchronous methods is been deprecated.") ;
 ...
 */
- (void)sendNotificationToUsersInBackground:(NSArray *)users completion:(BuiltRequestCompletionHandler)completionBlock; BUILTIO_DEPRECATED("sendNotificationToUsersInBackground:completion: is been deprecated.") ;
