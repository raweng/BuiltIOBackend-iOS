 ...
 */
- (BuiltSynchronousResponse *)exec:(NSError **)error BUILTIO_DEPRECATED("Synchronous methods is been deprecated.");
...
/**
 ...
 @deprecated Please use addQueryWithKey:andValue: instead.
 */
- (void)includeKey:(NSString *)key andValue:(NSString *)value BUILTIO_DEPRECATED("Please use addQueryWithKey:andValue: instead.");

/**
 @abstract Remove provided query key from custom query if exist.
 
 @param key Query name to remove.
 @deprecated Please use removeQueryWithKey: instead.
 */
- (void)removeKey:(NSString *)key BUILTIO_DEPRECATED("Please use removeQueryWithKey: instead.");
 ...
 */
- (void)beforeUID:(NSString *)uid BUILTIO_DEPRECATED("This method is been deprecated.");
 ...
 */
- (void)afterUID:(NSString *)uid BUILTIO_DEPRECATED("This method is been deprecated.");
